...
export default class SalesReturnManage extends React.Component {
  state = {
    urls: {
      list: '',
      add: '',
  ...
  render() {
    ...
    const searchData = [
      { type: 'chooseTime', field: 'shangpinleixingff',beginTime: 'tuihuoshijianbegin',EndTime: 'tuihuoshijianend', label: '退货时间', isEndTime: false, },
